    ...
    public Dictionary<PatternType, GameObject> GOPatternPrefabs
    {
        get
        {
            if (_goPatternPrefabs == null)
            {
                ...
                _goPatternPrefabs.Add(PatternType.PatternA, Resources.Load("Prefabs/A") as GameObject);
                _goPatternPrefabs.Add(PatternType.PatternB, Resources.Load("Prefabs/B") as GameObject);
            }
